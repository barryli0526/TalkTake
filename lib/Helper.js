...
//        {'forward.forward_at':{$gt:anchorTime}}]}]};
    var  basicQuery = {$or:[{$and:[{'author_id':{$in:friendsList}},{'post_at':{$gt:anchorTime}}]},{$and:[{'forward.forwarder_id' : {$in:friendsList}},
        {'forward.forward_at':{$gt:anchorTime}},{$nor:[{$and:[{'author_id':{$in:friendsList}},{'post_at':{$lte:anchorTime}}]},{$and:[{'forward.forwarder_id' : {$in:friendsList}},
            {'forward.forward_at':{$lte:anchorTime}}]}]}]}]};
